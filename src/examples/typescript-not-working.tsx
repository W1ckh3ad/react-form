...
const textAreaStringSchema = _createUniqueFieldSchema(z.string(), "TextArea2");
...
type Propss = {
  [Prop in keyof SchemaType["shape"]]: Omit<
    ComponentProps<GetComponentFromMapping<Mapping, SchemaType["shape"][Prop]>>,
